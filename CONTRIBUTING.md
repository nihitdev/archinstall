...
Bear in mind that in the future this repo might be transferred to the official [GitLab repo under Arch Linux](https://github.com/nihitdev/archlinux/) *(if GitLab becomes open to the general public)*.
